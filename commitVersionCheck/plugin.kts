...
//
//        checkinProjectPanel.selectedChanges.clear()
//        (checkinProjectPanel.component as ChangesViewCommitPanel).changesView
//                .run {
//                    changes.forEach {
//                        Env.println(it)
//                        selectedChanges.append(it)
//                        includeChanges(listOf(it))
//                    }
//                    selectedChanges.forEach {
//                        Env.println("aaa" + it)
//                    }
//                }
        ...
        if (versionTagData is XmlComment) {
            ...
            if (updateApi || updateData) {
                ...
                WriteCommandAction.runWriteCommandAction(project) {
                    ...
                    versionTag.replace(rootTag.createChildTag("version", null, versionList.joinToString("."), true))
